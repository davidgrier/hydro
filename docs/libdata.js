...
libdata[libdataItem++] = new Array("./blakeflow__define.html", "blakeflow__define.pro", '.pro file in <a href="./dir-overview.html">./ directory</a>', "blakeflow__define.pro", "    David G. Grier, New York University   ", "", " Flow field at specified points due to a stokeslet near  a horizontal wall in the plane $z = 0$.   Reference:  J. R. Blake,  A note on the image system for a stokeslet in  a no-slip boundary,  Proc. Cambridge Phil. Soc. 70, 303-310 (1971).   ", "", "          -1", "    Copyright (c) 2015 David G. Grier  ");
  ...
  libdata[libdataItem++] = new Array("./blakeflow__define.html#blakeflow::GetProperty", "blakeflow::GetProperty", 'routine in <a href="./blakeflow__define.html">blakeflow__define.pro</a>', "blakeflow__define.pro", "", "blakeflow::GetProperty", " blakeflow::GetProperty  ", "sources_ref_extra", "          -1", "");
  
  libdata[libdataItem++] = new Array("./blakeflow__define.html#blakeflow::Init", "blakeflow::Init", 'routine in <a href="./blakeflow__define.html">blakeflow__define.pro</a>', "blakeflow__define.pro", "", "blakeflow::Init", " blakeflow::Init()   ", "_ref_extra", "          -1", "    1 for success, 0 for failure   ");
...
libdata[libdataItem++] = new Array("./oseentensor__define.html", "oseentensor__define.pro", '.pro file in <a href="./dir-overview.html">./ directory</a>', "oseentensor__define.pro", "    David G. Grier, New York University.   ", "", " Oseen tensor base class for describing hydrodynamic flows  relative to specified positions.   ", "", "          -1", "    Copyright (c) 2015 David G. Grier  ");
  ...
  libdata[libdataItem++] = new Array("./oseentensor__define.html#oseentensor::Init", "oseentensor::Init", 'routine in <a href="./oseentensor__define.html">oseentensor__define.pro</a>', "oseentensor__define.pro", "", "oseentensor::Init", " oseentensor::Init()   ", "position        Position of source in Cartesian coordinates.  viscosity        Viscosity of medium.  radius        distance of closest approach.   ", "          -1", "    1 for success, 0 for failure   ");
